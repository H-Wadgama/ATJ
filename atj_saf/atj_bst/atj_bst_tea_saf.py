...
from atj_saf.atj_bst.atj_bst_tea_abstract import AbstractTEA
...
class ConventionalEthanolTEA(AbstractTEA):
    """
    ...
    def __init__(self, system, IRR, duration, depreciation, income_tax,
                 ...
                 labor_cost, #fringe_benefits, 
                 property_tax,
                 property_insurance, #supplies, 
                 maintenance, administration):
        super().__init__(system, IRR, duration, depreciation, income_tax,
                         operating_days, lang_factor, construction_schedule,
                         startup_months=3., startup_FOCfrac=1., startup_VOCfrac=0.75,
                         startup_salesfrac=0.5, finance_interest=0.08, finance_years=10,
                         finance_fraction=0.6, WC_over_FCI=WC_over_FCI)
